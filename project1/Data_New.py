...
def Data(k,dim,n):
    if os.path.exists("data" + str(k)+"_"+str(dim)+"_"+str(n)+ "_new.npy"):
        data = np.load("data" + str(k)+"_"+str(dim)+"_"+str(n) + "_new.npy")
    ...
    np.save("data" + str(k) + "_" + str(dim) + "_" + str(n)+"_new", data_write)
